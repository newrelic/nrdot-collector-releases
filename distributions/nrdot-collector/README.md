...
| On-Host Integrations (OHI) | `alpha` | N/A (new)                 | [Kafka](https://docs.newrelic.com/docs/opentelemetry/integrations/kafka/overview/), [Elasticsearch](https://docs.newrelic.com/docs/opentelemetry/integrations/elasticsearch/elasticsearch-otel-integration-overview/), [NGINX](https://docs.newrelic.com/docs/opentelemetry/integrations/nginx/nginx-otel-overview/), [RabbitMQ](https://docs.newrelic.com/docs/opentelemetry/integrations/rabbitmq/overview/), [Redis](https://docs.newrelic.com/docs/opentelemetry/integrations/redis/overview/), [ECS](https://docs.newrelic.com/docs/opentelemetry/integrations/ecs-monitoring/overview/), [HAProxy](https://docs.newrelic.com/docs/opentelemetry/integrations/haproxy/overview/) |
