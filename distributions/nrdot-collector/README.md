...
| On-Host Integrations (OHI) | `alpha` | N/A (new)                 | [ECS](https://docs.newrelic.com/docs/opentelemetry/integrations/ecs-monitoring/overview/), [ElasticSearch](https://docs.newrelic.com/docs/opentelemetry/integrations/elasticsearch/elasticsearch-otel-integration-overview/), [HAProxy](https://docs.newrelic.com/docs/opentelemetry/integrations/haproxy/overview/), [Kafka](https://docs.newrelic.com/docs/opentelemetry/integrations/kafka/overview/), [NGINX](https://docs.newrelic.com/docs/opentelemetry/integrations/nginx/nginx-otel-overview/), [RabbitMQ](https://docs.newrelic.com/docs/opentelemetry/integrations/rabbitmq/overview/), [Redis](https://docs.newrelic.com/docs/opentelemetry/integrations/redis/overview/) |
| Database Monitoring       | `alpha`   | N/A (new)                 | [Microsoft SQL Server](https://docs.newrelic.com/docs/opentelemetry/database/mssql/introduction/), [Oracle DB](https://docs.newrelic.com/docs/opentelemetry/database/oracle/introduction/), [MySQL](https://docs.newrelic.com/docs/opentelemetry/database/mysql/introduction/), [PostgreSQL](https://docs.newrelic.com/docs/opentelemetry/database/postgresql/introduction/)|
